...
public class Input {
    ...
    public static void main(String[] args) {
        File fileIn = new File("C:\\Users\\admin\\IdeaProjects\\link_word\\src\\main\\java\\com\\example\\webdemo\\input\\input.txt");
        File fileOut = new File("C:\\Users\\admin\\IdeaProjects\\link_word\\src\\main\\java\\com\\example\\webdemo\\input\\error.txt");
        try {
